...
if( isset($_POST["parameter"]) )
{
    ...
    <table width='2200' border='1' cellpadding='0' cellspacing='0' align='center'>
        <tr>
            ...
            <td width='200'>Наименование услуги</td>
            <td width='100'>Опции</td>
        </tr>";
    ...
    {   
        ...
        echo    "<td width='120'>".$data['customer_country']."</td>";
        echo    "<td width='200'>".$data['customer_compname']."</td>";
        echo    "<td width='100'><center><input type=button value=редактировать onclick=location.href='draft_edit.php?edit=".$data['customer_id']."' /></center></td>";
        echo "</tr>";
    }
    echo "</table>";
...
echo "
    ...
    {   
        ...
        echo    "<td width='120'>".$data['customer_country']."</td>";
        echo    "<td width='200'>".$data['customer_compname']."</td>";
        echo    "<td width='100'><center><input type=button value=редактировать onclick=location.href='../system/draftEdit.php?edit=".$data['customer_id']."' /></center></td>";
        echo "</tr>";
    }
    echo "</table>";
}
