...
class draftLoaderGeneral {
    function loadDraft() 
    {
        ...
        {       
            ...
            echo    "<td width='200'><center>".$data['customer_surn']." ".$data['customer_name']."</td>";
            ...
            echo    "<td width='160'><center>".$data['customer_country']."</td>";
            echo    "<td width='160'><center>".$data['customer_city']."</td>";
