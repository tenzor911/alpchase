<?php
class registryLoaderFilter 
{
    function loadRegistryByFilter($filterData, $filterParameter)
    {
        $result = mysql_query("SELECT * FROM users_customers WHERE $filterData = '$filterParameter' AND quest_status != 'черновик'");
