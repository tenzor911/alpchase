function addSection() {
	var section_count = $("#countSections").val();
	section_count++;

	var section_i = $("#iSections").val();
	section_i++;
...
function addService( section_i ) {
	...
	if( country_id > 0 ) selectCountry(section_i + ''+service_i, country_id);
	$("#countServices"+section_i).val(service_count);
	$("#iServices"+section_i).val(service_i);
}
